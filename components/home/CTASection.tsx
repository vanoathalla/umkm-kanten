...
export default function CTASection() {
  return (
    <section className="py-24 bg-[#011f6d] relative overflow-hidden">
      {/* Decorative blobs */}
      <div className="absolute -top-24 -right-24 w-72 h-72 bg-[#ffaa4d]/10 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute -bottom-24 -left-24 w-72 h-72 bg-[#ffaa4d]/10 rounded-full blur-3xl pointer-events-none" />

      <div className="relative max-w-3xl mx-auto px-4 text-center">
        {/* Aksara Jawa */}
        <p className="aksara text-[#ffaa4d]/50 text-2xl tracking-widest mb-3">ꦢꦥ꧀ꦠꦫꦏꦤ꧀ꦈꦱꦲ</p>

// seed_all.js — upsert semua UMKM ke Supabase (sync penuh dari data/umkm.ts)
...
const allUMKM = [
  ...
  },
  {
    ...
    instagram: '', facebook: '', shopee: '', tokopedia: '',
    jam_operasional: '05.30 - 08.00 WIB (Setiap Hari)',
  ...
  // ── RT 02 ──
  {
    ...
    instagram: '', facebook: '', shopee: '', tokopedia: '',
    jam_operasional: '08.00 - 17.00 WIB (Setiap Hari, Pesanan bisa kapan saja)',
    featured: true, galeri: [],
  },
  {
    ...
    instagram: '', facebook: '', shopee: '', tokopedia: '',
    jam_operasional: '10.00 - 19.00 WIB (Setiap Hari)',
    featured: false, galeri: [],
  },
  {
    id: 'sate-bu-sriyanti',
    ...
    instagram: '', facebook: '', shopee: '', tokopedia: '',
    jam_operasional: '16.00 - 21.00 WIB (Setiap Hari)',
    featured: false, galeri: [],
  },
  ...
  },
  {
    ...
    sejarah: 'Bu Sugi telah berjualan kue dan jajanan selama kurang lebih 18 tahun. Produknya dititipkan di angkringan dan pasar sekitar.',
    alamat: 'RT 03, Dusun Kanten, Desa Kebonagung, Kec. Imogiri, Bantul',
    rt: 'RT 03', maps: '', whatsapp: '6281234560007',
    instagram: '', facebook: '', shopee: '', tokopedia: '',
    jam_operasional: '06.00 - 16.00 WIB (Setiap Hari, Pesanan diterima)',
    featured: true, galeri: [],
  },
  {
    id: 'tempe-bu-ning',
    ...
    instagram: '', facebook: '', shopee: '', tokopedia: '',
    jam_operasional: '06.00 - 12.00 WIB (Setiap Hari)',
    featured: false, galeri: [],
  },
  {
    ...
    instagram: '', facebook: '', shopee: '', tokopedia: '',
    jam_operasional: '07.00 - 15.00 WIB (Setiap Hari)',
    featured: false, galeri: [],
  },
  ...
  // ── RT 04 ──
  {
    ...
    sejarah: 'Mas Arif Munawar mengembangkan usaha nasi gorengnya dari skala rumahan hingga kini aktif berjualan di Pasar Barongan dan weekend di Depok.',
  ...
  },
  {
    ...
    instagram: '', facebook: '', shopee: '', tokopedia: '',
    jam_operasional: '07.00 - 16.00 WIB (Setiap Hari)',
    featured: false, galeri: [],
  },
  ...
  // ── RT 05 ──
  {
    ...
    sejarah: 'Mbah Bini memproduksi tempe sejak lebih dari 10 tahun lalu. Kini fokus ke tempe daun (dibungkus daun pisang) yang lebih diminati karena cita rasanya lebih autentik.',
    alamat: 'RT 05, Dusun Kanten, Desa Kebonagung, Kec. Imogiri, Bantul',
    rt: 'RT 05', maps: '', whatsapp: '6281234560013',
    instagram: '', facebook: '', shopee: '', tokopedia: '',
    jam_operasional: '06.00 - 11.00 WIB (Setiap Hari)',
    featured: true, galeri: [],
  },
  {
    ...
    sejarah: 'Bu Yanti berjualan kipas batik sejak tahun 1990-an. Selain melayani pesanan lokal, beliau pernah menerima pesanan dari luar negeri termasuk Meksiko.',
    alamat: 'RT 05, Dusun Kanten, Desa Kebonagung, Kec. Imogiri, Bantul',
    rt: 'RT 05', maps: '', whatsapp: '6281234560014',
    instagram: 'kipas_batik_yanti', facebook: '', shopee: '', tokopedia: '',
    jam_operasional: '08.00 - 17.00 WIB (Setiap Hari)',
    featured: true, galeri: [],
  },
  {
    ...
    instagram: '', facebook: '', shopee: '', tokopedia: '',
    jam_operasional: '07.00 - 20.00 WIB (Setiap Hari)',
    featured: false, galeri: [],
  },
  ...
  // ── Showroom ──
  {
    ...
    sejarah: 'Showroom Desa Prima Agung Mandiri merupakan kelompok UMKM lingkup kelurahan yang berlokasi di RT 01 depan lapangan Kelurahan Kebonagung.',
...
async function run() {
  console.log(`Upserting ${allUMKM.length} entries...`);
  const { error } = await supabase.from('umkm').upsert(allUMKM, { onConflict: 'id' });
  if (error) {
    console.error('Error:', JSON.stringify(error, null, 2));
    process.exit(1);
  }
  console.log(`Done! ${allUMKM.length} entries upserted.`);

  // Verify
  const { data, error: err2 } = await supabase.from('umkm').select('id, nama, rt').order('rt');
  if (!err2) {
    console.log('\nData di DB sekarang:');
    data.forEach(r => console.log(` ${r.rt} | ${r.nama}`));
  }
}
